# To execute this script use -> python autonomousGPSIMU_mongoDB.py "<apartmentNo>"
...
ARUCOID = apartmentDetails["arucoID"]
...
arm_and_takeoff(INITIAL_HEIGHT)
...
point3 = LocationGlobalRelative(LAT, LONG, INITIAL_HEIGHT)
